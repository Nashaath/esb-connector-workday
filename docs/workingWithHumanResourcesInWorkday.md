...
**Properties**
* workdayGetAcademicRanksRecords: One or more criteria based on which you want to retrieve details. For example, if you want to retrieve details based on the academic rank ID, you can specify "academicRankId" as the criteria.
...
**Properties**
* workdayGetAcademicUnitHierarchiesRecords: One or more criteria based on which you want retrieve details. For example, if you want to retrieve details related to a particular academic unit hierarchy, you can specify that particular academic unit hierarchy ID.
...
**Properties**
* workdayGetAcademicUnitsRecords: One or more criteria based on which you want to retrieve details. For example, if you want to retrieve details related to a particular academic unit, you can specify the particular academic unit ID.
...
**Properties**
* workdayGetCompanyInsiderTypesRecords: One or more criteria based on which you want to retrieve details.
...
**Properties**
* workdayGetDisabilitiesRecords: One or more criteria based on which you want to retrieve details. For example, if you want to retrieve details related to a particular disability that is defined, you can specify "disabilityId" as one of the criteria.
...
**Properties**
* workdayGetEthnicitiesRecords: One or more criteria based on which you want to retrieve details. For example, if you want to retrieve details related to a particular ethnicity, you can specify "ethnicityId" as one of the criteria.
...
**Properties**
* workdayGetFrequenciesRecords: One or more criteria based on which you want to retrieve details. For example, if you want to retrieve details related to a particular frequency, you can specify "frequencyId" as one of the criteria.
...
**Properties**
* workdayGetGenderIdentitiesRecords: One or more criteria based on which you want to retrieve details. 
...
**Properties**
* workdayGetJobCategoriesRecords: One or more criteria based on which you want to retrieve details.
...
**Properties**
* workdayGetWorkersRecords: One or more criteria based on which you want to retrieve details. For example, if you want to retrieve details related to one or more workers, you can specify the employee IDs of those workers.
